...
const Edit = ( { attributes, setAttributes } ) => {
	...
	const containerClasses = additionalClass
		? `wp-block-fancysquares-container-block container ${ additionalClass }`
		: 'wp-block-fancysquares-container-block container';
			...
			<InspectorControls>
				...
				>
					<SelectControl
						...
						onChange={ ( newVal ) =>
							setAttributes( { additionalClass: newVal } )
						}
					/>
				</PanelBody>
			</InspectorControls>
